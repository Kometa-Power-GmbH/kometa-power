...
export default function Index({ benefit, imageAtRight }: Props) {
  ...
  return (
    <section className="benefit-section">
      ...
      >
        <div
          className={clsx(
            "flex flex-wrap items-center w-full max-w-lg px-6 lg:px-0",
            {
        ...
        >
          <div className="w-full text-center lg:text-left ">
            ...
            >
              <h3 className="text-4xl font-bold text-[#FDEAA8]">{title}</h3>

              <p className="mt-7 mx-auto lg:ml-0 leading-normal">
                {description}
              </p>
            </motion.div>
