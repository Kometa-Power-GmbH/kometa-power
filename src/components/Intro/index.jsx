  ...
  return (
    <div className="h-screen relative overflow-hidden">
      ...
      <div className="absolute inset-0 flex flex-col justify-center items-center text-white text-center px-4">
        ...
        >
          <h2 className="text-[1.25rem] md:text-3xl font-extrabold text-[#b7ab98] uppercase">
            Kometa steht für Energie, Präzision und technische Power
          </h2>
          <h2 className="text-[1.375rem] text-[#ec4e39] md:text-5xl font-extrabold mt-3 uppercase">
          ...
          <div className="flex flex-col justify-center items-center gap-6 mt-10">
            <a
              href="#contact"
              className="px-6 py-3 text-[#b7ab98] border border-[#b7ab98] font-semibold rounded-full hover:bg-[#ec4e39] hover:border-[#ec4e39] hover:text-white transition"
            >
            ...
            >
              <FaWhatsapp color="#b7ab98" size={70} />
            </a>
          </div>
        </motion.div>
      </div>
